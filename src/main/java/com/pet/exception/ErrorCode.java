...
public enum ErrorCode {
    ...
    TOKEN_EXPIRED("TOKEN_EXPIRED", "Token 已過期"),
    INVALID_REFRESH_TOKEN("INVALID_REFRESH_TOKEN", "Refresh Token 無效"),
    ACCESS_DENIED("ACCESS_DENIED", "無權限訪問"),
    WEB_ACCESS_RESTRICTED("WEB_ACCESS_RESTRICTED", "Web 端功能正在開發中,僅限管理員使用"),
